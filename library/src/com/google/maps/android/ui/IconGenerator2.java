 ...
 * window-like shape.
 * <p/>
 * The icon {@link android.graphics.Bitmap}s generated by the factory should be used in conjunction with a {@link
...
public class IconGenerator2 {
     ...
     */
    public IconGenerator2(Context context) {
        mContext = context;
    }
     ...
     * <p/>
     * If the view contains a {@link android.widget.TextView} with the id "text", operations such as {@link
     * #setTextAppearance} and {@link #makeIcon(String)} will operate upon that {@link android.widget.TextView}.
     */
    ...
    private void ensureViewsSetUp() {
        if (mContainer == null) {
            mContainer = (ViewGroup) LayoutInflater.from(mContext).inflate(R.layout.text_bubble2, null);
            ...
            mStatusView = (TextView) mContainer.findViewById(R.id.status);
        }
    }
